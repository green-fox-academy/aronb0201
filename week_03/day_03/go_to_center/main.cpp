...
void drawThreeLines (){
    for (int i = 0; i < 3; ++i){
        int startPosX = (SCREEN_WIDTH-640)+(10*i);
        int startPosY = (SCREEN_HEIGHT-480) + (10*i);
        SDL_SetRenderDrawColor(gRenderer, 0xFF, 0x00, 0x00, 0xFF);
        SDL_RenderDrawLine(gRenderer, startPosX, startPosY, (SCREEN_WIDTH/2), (SCREEN_HEIGHT/2));
